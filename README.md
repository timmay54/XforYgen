...
Some items are mentions more than once in the text file, like Uber.  This increases the likelihood that it is chosen. We do this only for a few items since they tend to work better more often.
